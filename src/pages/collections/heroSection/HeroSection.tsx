...
const HeroSection = () => {
  ...
  return (
    <>
      <div className="w-[375px] h-[786px] gap-[40px] px-[40px] md:w-[834px] md:h-[541px] md:pt-[40px] md:pb-[80px] md:gap-[30px] md:px-[115px] lg:w-[1280px] lg:h-[704px] lg:px-[115px] lg:py-[80px] lg:gap-[30px]">
