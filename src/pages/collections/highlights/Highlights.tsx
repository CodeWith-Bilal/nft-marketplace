  ...
  return (
    <div>
      {collections.slice(20, 21).map((item, i) => {
        return (
          <div key={i} className="bg-cover bg-no-repeat z-0 w-full mt-6">
            <div className="w-full h-[640px] flex-col justify-start items-center inline-flex">
              <div className="w-full pt-[360px] pb-[60px] bg-gradient-to-b z-10 from-purple-200/30 to-purple-400/60 justify-center items-end inline-flex mix-blend-multiplier">
