...
const BrowseCard: React.FC<BrowseCardProps> = ({ item }) => {
  return (
    <Link to={`/collection/${item.collection}`}>
      <div className="flex flex-col w-[147.5px] h-[209px] md:w-[150px] msc:w-[165px] msc:h-[209px] ls:w-[243px] xl:w-80 ls:h-[316px] rounded-[20px] bg-[#3B3B3B]">
        <div className="w-[147.5px] h-[142px] md:w-[150px] msc:w-[165px] msc:h-[142px] ls:w-[243px] ls:h-[240px] xl:w-80 rounded-tl-[20px] rounded-tr-[20px]">
          <img
            className="relative w-[147.5px] h-[142px] md:w-[150px] msc:w-[165px] msc:h-[142px] ls:w-[243px] ls:h-[240px] xl:w-80 rounded-tl-[20px] rounded-tr-[20px] object-cover"
            src={item.image_url}
