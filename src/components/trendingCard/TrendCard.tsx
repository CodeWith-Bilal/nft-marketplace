...
const TrendCard: React.FC<TrendCardProps> = ({ item, display }) => {
  return (
    <div className={`${display}`}>
      <div className="w-[325px] h-[505px] msc:w-[362px] msc:h-[525px] ls:w-[330px] rounded-[20px] flex flex-col justify-start items-start gap-[15px] bg-[#2B2B2B]">
        <div className="w-[325px] h-[425px] msc:w-[362px] msc:h-[445px] ls:w-[330px] flex flex-col gap-[15px]">
          <div className="w-[315px] h-[315px] msc:w-[362px] msc:h-[330px] ls:w-[330px] rounded-[20px]">
            <Link to={`/collection/${item.collection}`}>
              <img
                src={item.image_url}
                alt={item.collection.slice(0, 10)}
                className="w-[315px] h-[315px] msc:w-[362px] msc:h-[330px] ls:w-[330px] rounded-[20px] object-cover"
              />
            </Link>
          </div>
          <div className="w-[315px] h-[95px] msc:w-[362px] msc:h-[100px] ls:w-[330px] items-center justify-center gap-[15px] inline-flex">
            <div className="w-[95px] h-[95px] msc:w-[110px] msc:h-[110px] ls:w-[100px] ls:h-[100px] rounded-[20px]">
              <Link to={`/collection/${item.collection}`}>
                <img
                  className="w-[95px] h-[95px] msc:w-[110px] msc:h-[110px] ls:w-[100px] ls:h-[100px] rounded-[20px]"
                  src={item.image_url}
                  alt=""
                />
              </Link>
